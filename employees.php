...
<body>
    ...
    <div class="intro">
        <div class="container">
          <div class="intro__content">
            <div class="intro__items" style="font-size: 48px; font-weight: 900;">Employees</div>
            <div class="employeesContainer" id="employeesContainer">
    ...
    <div class="popup-bg" style="display: none">
      <div class="popup">
        ...
        <div>
          <input type="button" class="up" value="Up"><br>
          <input type="button" class="deup" value="Deup">
        </div>
      </div>
    </div>

    <script src="/js/jquery.min.js"></script>
    <script src="js/authEmployees.js"></script>
    <script src="employeesDelete.js"></script>
</body>
</html>